...
<template>
  <div>
    <bma-timeline pending="Recording..." :reverse="reverse">
      <bma-timeline-item>Create a services site 2015-09-01</bma-timeline-item>
      <bma-timeline-item>Solve initial network problems 2015-09-01</bma-timeline-item>
      <bma-timeline-item>Technical testing 2015-09-01</bma-timeline-item>
    </bma-timeline>
    <bma-button type="primary" style="margin-top: 16px" @click="handleClick">
      Toggle Reverse
    </bma-button>
  </div>
</template>
