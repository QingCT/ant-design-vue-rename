...
<template>
  ...
  <div>
    <div v-for="color in colors" :key="color">
      <bma-badge :color="color" :text="color" />
    </div>
  </div>
  <bma-divider orientation="left">Custom</bma-divider>
  <bma-badge color="#f50" text="#f50" />
  <br />
  <bma-badge color="#2db7f5" text="#2db7f5" />
  <br />
  <bma-badge color="#87d068" text="#87d068" />
  <br />
  <bma-badge color="#108ee9" text="#108ee9" />
</template>
<script lang="ts">
