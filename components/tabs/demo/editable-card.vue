...
<template>
  <bma-tabs v-model:activeKey="activeKey" type="editable-card" @edit="onEdit">
    <bma-tab-pane v-for="pane in panes" :key="pane.key" :tab="pane.title" :closable="pane.closable">
      {{ pane.content }}
    </bma-tab-pane>
  </bma-tabs>
</template>
