...
describe('Button', () => {
  ...
  it('create primary button', () => {
    ...
    expect(wrapper.find('.bmant-btn-primary').exists()).toBe(true);
  });
  ...
  it('renders Chinese characters correctly', done => {
    ...
    nextTick(() => {
      // expect(wrapper6.find('.bmant-btn-two-chinese-chars').exists()).toBe(true);
  ...
  it('should change loading state instantly by default', async () => {
    ...
    await asyncExpect(() => {
      expect(wrapper.findAll('.bmant-btn-loading').length).toBe(1);
    });
  });
  ...
  it('should change loading state with delay', async () => {
    ...
    await asyncExpect(() => {
      expect(wrapper.find('.bmant-btn-loading').exists()).toBe(false);
    });
  });
  ...
  it('should support to change loading', async () => {
    ...
    await sleep();
    expect(wrapper.findAll('.bmant-btn-loading').length).toBe(0);
