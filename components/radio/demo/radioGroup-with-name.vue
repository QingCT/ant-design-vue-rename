...
<template>
  <bma-radio-group v-model:value="value" name="radioGroup">
    <bma-radio value="1">A</bma-radio>
    <bma-radio value="2">B</bma-radio>
    <bma-radio value="3">C</bma-radio>
    <bma-radio value="4">D</bma-radio>
  </bma-radio-group>
</template>
<script lang="ts">
