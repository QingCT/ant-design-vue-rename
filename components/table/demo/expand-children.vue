...
<template>
  <bma-space align="center" style="margin-bottom: 16px">
    CheckStrictly:
    <bma-switch v-model:checked="rowSelection.checkStrictly"></bma-switch>
  </bma-space>
  <bma-table :columns="columns" :data-source="data" :row-selection="rowSelection" />
</template>
<script lang="ts">
