...
| type | The type of input, see: [MDN](https://developer.mozilla.org/docs/Web/HTML/Element/input#Form_%3Cinput%3E_types)(use `<bma-textarea />` instead of `type="textarea"`) | string | `text` |  |
