...
<template>
  <bma-space direction="vertical">
    ...
    <bma-date-picker v-model:value="value2" disabled picker="month" />
    <bma-range-picker v-model:value="value3" disabled />
    <bma-range-picker v-model:value="value4" :disabled="[false, true]" />
  </bma-space>
</template>
<script lang="ts">
