...
<template>
  ...
  >
    ...
    >
      ...
      >
        <bma-input v-model:value="user.first" placeholder="First Name" />
      </bma-form-item>
      <bma-form-item
      ...
      >
        <bma-input v-model:value="user.last" placeholder="Last Name" />
      </bma-form-item>
      <MinusCircleOutlined @click="removeUser(user)" />
    </bma-space>
    <bma-form-item>
      <bma-button type="dashed" block @click="addUser">
        <PlusOutlined />
        Add user
      </bma-button>
    </bma-form-item>
