<template>
  ...
  >
    <bma-menu-item v-if="showOverview" key="/components/overview">
    ...
    <template v-for="m in menus">
      <template v-if="m.children">
        <bma-menu-item-group :key="m.order" :title="isZhCN ? m.title : m.enTitle">
          <template v-for="n in m.children">
            <bma-menu-item v-if="n.path" :key="n.path">
