...
export default {
  ...
  render() {
    ...
    return (
      <header id="header">
        <bma-row>
          <bma-col class="header-left" xxxl={3} xxl={4} xl={5} lg={5} md={6} sm={24} xs={24}>
          ...
          <bma-col xxxl={20} xxl={20} xl={19} lg={19} md={18} sm={0} xs={0}>
            <div id="search-box">
              <SearchOutlined />
              <bma-input
            ...
            <bma-select
              ...
              class="version"
            >
              <bma-select-option value={packageInfo.version}>
                {packageInfo.version}
              </bma-select-option>
              <bma-select-option
                value="1.x"
                onClick={() => (location.href = 'https://1x.antdv.com')}
              >
                1.x
              </bma-select-option>
            </bma-select>
            <bma-menu selectedKeys={selectedKeys} mode="horizontal" class="menu-site" id="nav">
              ...
              {isCN ? (
                <bma-menu-item key="store">
                  ...
                  >
                    商店
                    <bma-badge color="red" style="position: absolute;top: -10px;right: -10px;" />
                  </a>
                </bma-menu-item>
              ) : null}
              {isCN ? (
                <bma-menu-item key="geektime">
                  <a
              ...
              <bma-sub-menu key="Ecosystem" title={isCN ? '更多' : 'More'}>
                <bma-menu-item key="pro">
                  <a target="_blank" href="https://pro.antdv.com">
                    Pro (Admin)
                  </a>
                </bma-menu-item>
                <bma-menu-item key="design">
                  <router-link
                    to={{
